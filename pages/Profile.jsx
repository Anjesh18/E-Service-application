...
export default function Profile() {
  ...
  return (
    <div className="max-w-6xl items-start mx-auto px-9 py-2 my-4">
      ...
      <hr className="my-5"/>
      <h1 className="text-3xl text-red-600 font-extrabold"> Services posted by you:</h1>
      <div className="w-4xl">
     {
      servicesForSingleProvider.length>1?<p className="text-2xl">You have not posted any services yet!</p> : <div> {servicesForSingleProvider?.map((item, idx) => (
